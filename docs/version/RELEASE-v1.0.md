...
## v1.0.5 (2026-09-04 · 2026-09-08 追加 · 2026-09-14 追加文档) 📝 待发布

> 2026-09-08 追加修复（不推进版本号）：v1.0.5 仍处「待发布」状态，密码生成器填入与移动端粘贴两个修复并入本分节一起发布。
>
> 2026-09-14 追加文档（不推进版本号）：docs 补充 macOS 桌面版首次打开被 Gatekeeper 拦截（提示「已损坏，无法打开」）的解除隔离指引——终端执行 `xattr -dr com.apple.quarantine "/Applications/LockPass.app"`（涉及 docs/wiki 快速上手、桌面版与自动更新、常见问题，以及 docs/tauri.md 与 docs/lockpass-扩展使用指南）。
